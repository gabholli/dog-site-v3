...
export default function BreedList() {
    ...
    const pagination = pageNumbers.map(number => (
        <li
            key={number}
            className="hover:underline active:font-semibold size-8 bg-slate-300 flex justify-center items-center rounded-lg"
        >
    ...
    if (error) {
        return (
            <div className="flex flex-col justify-center items-center">
                ...
                <Link href="/" passHref>
                    <div className="bg-slate-300 px-4 py-2 rounded-xl text-xl hover:underline">Return to home</div>
                </Link>
            </div>
        )
    }
