...
export default function BreedList() {
    ...
    const pagination = pageNumbers.map(number => (
        <li
            key={number}
            className="hover:underline active:font-semibold size-8 bg-neutral-200 flex justify-center items-center rounded-lg"
        >
    ...
    if (error) {
        return (
            <div className="flex flex-col justify-center items-center">
                ...
                <Link href="/" passHref>
                    <div className="bg-neutral-200 px-4 py-2 rounded text-xl hover:underline">Return to home</div>
                </Link>
            </div>
        )
    }
